  ...
  return (
    <div className="flex flex-col gap-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <HtmlContent
        content={content}
        className={cn(
          'p-6 bg-blue-50 rounded-3xl max-h-[320px] overflow-y-auto text-sm text-blue-800 border border-blue-100 shadow-inner leading-relaxed text-right [&_h3]:text-base [&_h3]:font-bold [&_h3]:mb-2 [&_p]:mb-3 [&_section]:mb-4 custom-scrollbar',
          contentClassName
        )}
      />
