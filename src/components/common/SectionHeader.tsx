...
const variantMap: Record<SectionHeaderVariant, string> = {
...
export const SectionHeader: React.FC<SectionHeaderProps> = ({ icon, title, variant = 'blue', className }) => {
  return (
    <div className={cn('flex items-center gap-3 mb-6', className)}>
      <div className={cn('w-10 h-10 text-white rounded-xl flex items-center justify-center shadow-lg', variantMap[variant])}>
