...
export const AnimatedHouse: React.FC<AnimatedHouseProps> = ({
  className,
  variants,
}) => {
  return (
    <motion.div
      ...
      className={cn(
        'w-48 h-48 bg-white rounded-[2.5rem] shadow-2xl flex items-center justify-center text-blue-600 border border-blue-50 relative',
        className
      )}
    >
