...
interface PropertyPageProps {
  ...
  userEmail?: string;
  onResultsModeChange?: (isResults: boolean) => void;
}
...
export const PropertyPage: React.FC<PropertyPageProps> = ({ onNavigate, showTour, setShowTour, userEmail, onResultsModeChange }) => {
  // --- State ---
  ...
  useEffect(() => {
    onResultsModeChange?.(viewMode === 'results');
  }, [viewMode, onResultsModeChange]);
