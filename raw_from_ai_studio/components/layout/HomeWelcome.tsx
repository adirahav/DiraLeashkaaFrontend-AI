...
import { Building2, Plus, Image as ImageIcon, Sparkles } from 'lucide-react';
...
interface HomeWelcomeProps {
  onAddPropertiesPress: (screen: Screen) => void;
  showTour: boolean;
  setShowTour: (show: boolean) => void;
}

export const HomeWelcome: React.FC<HomeWelcomeProps> = ({ onAddPropertiesPress, showTour, setShowTour }) => {
    ...
    <div className="w-full flex flex-col items-center justify-center py-12 text-right relative overflow-hidden" dir="rtl">
      ...
      >
        ...
        <div className="p-10 text-center -mt-16 relative z-10">
          ...
          <motion.p 
            variants={itemVariants}
            className="text-slate-600 text-xl font-bold mb-10 leading-relaxed max-w-md mx-auto"
          >
            אנחנו שמחים שהצטרפת אלינו. 
            כדי להתחיל לנהל את ההשקעות שלך בצורה חכמה, 
            בוא נזין את הנכס הראשון שלך במערכת.
          </motion.p>
